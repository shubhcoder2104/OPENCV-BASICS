...
print(f"these are the label {labels}")
print(f"target labels {target_labels}")


# Seeing image dimensions and number of images
print(f"number of images {no_of_sample}")
print(f"image height and width  {height} x {width}")
